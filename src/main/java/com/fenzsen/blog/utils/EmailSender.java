...
public class EmailSender {
    ...
    private EmailSender() {
        EmailSender.config(EmailSender.SMTP_163(false), "fenzsen@163.com", "MEPENVMOGNVKHJCR");
    }
    ...
    public static void sendRegisterVerifyCode(String code,String emailAddress) throws Exception{
        EmailSender.subject("博客系统注册验证码").from("博客系统").
                text("您的验证为："+code+",10分钟内有效。你正在使用注册功能，该验证码仅用于身份验证，请勿泄露给他人使用。")
                .to(emailAddress).send();
    }
}
